...
public class CreateQrcode_IDCard {
	...
	public static void main(String[] args) throws IOException {
        ...
        String str="BEGIN:VCARD\n"+
                   "PHOTO;VALUE=uir:http://b242.photo.store.qq.com/psb?/V100Gzq740G1kt/eJ6tWVfo2kMLsYLaOJ0DG0NpLm4e*0KDp2.Cscc.GBI!/m/dPIAAAAAAAAAnull&bo=tQK1AgAAAAARBzA!&rf=photolist&t=5\n" +
                   "FN:姓名:罗梦硕\n"+
                   "TITLE:河北科技师范学院学生\n"+
                   "ADR;WORK:;;秦皇岛海港区西港镇河北大街西段360号\n"+
                   "TEL;CELL,VOICE:13933843139\n"+
                   "TEL;WORK,VOICE:15032360306\r\n"+
                   "URL;WORK:http://www.hevttc.edu.cn\n"+
                   "EMAIL;INTERNET,HOME:991303767@qq.com\n"+
                   "END:VCARD";//二维码扫出来的内容
        //得到一个二维数组
        ...
        Image logo=ImageIO.read(new File("D:/头像/lmsid.jpg"));
        int logosize=50;
